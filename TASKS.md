...
## Milestone P4：稅則判定模組研究與規格化
目標：把「台灣出口到中國大陸商品如何決定稅則」整理成合法合規、可追溯來源的研究文件與模組規格。

### P4-1 研究文件
- [x] 整理台灣出口 / 中國進口視角下的稅則決定流程
- [x] 明確區分：稅則歸類、ECFA 覆蓋判斷、原產地認定、文件要求
- [x] 列出模組使用的官方資料來源與連結
- [x] 標註哪些部分只能做 pre-classification、不能冒充最終海關裁定

### P4-2 模組規格
- [x] 設計「稅則判定模組」的輸入欄位
- [x] 設計候選號列 / 判定依據 / 風險提示 / 缺資料提示的輸出結構
- [x] 設計與現有 ECFA precheck / optimize 流程的串接方式
- [x] 補上合法合規聲明與人工覆核節點

**完成標準**
- [x] repo 內至少新增一份研究文件與一份模組規格文件
- [x] 文件中含官方資料來源連結與法規邊界說明
